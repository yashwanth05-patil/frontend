        ...
        <div className='w-full p-2'>
            ...
            <div className='w-full mt-6 md:flex flex-row items-center gap-4'>
                <div className='relative w-full mt-3 md:w-[49%]'>
                    <div className="absolute bottom-3 left-3 right-3 z-10 rounded-card bg-ink/80 px-4 py-4 flex items-center justify-center gap-3">
                        <span className="mono-readout text-paper-raised">LEARN MORE</span>
                    </div>
                    <img className="w-full object-contain rounded-card border border-slate-line" src="/img4.png" alt="" />
                </div>
                <div className='relative w-full mt-3 md:w-[49%]'>
                    <div className="absolute bottom-3 left-3 right-3 z-10 rounded-card bg-ink/80 px-4 py-4 flex items-center justify-center gap-3">
                        <span className="mono-readout text-paper-raised">LEARN MORE</span>
                    </div>
                    <img className="w-full object-contain rounded-card border border-slate-line" src="/img5.png" alt="" />
                </div>
            </div>
